...
----
SEND
destination:/app/games/{gameId}/gamer/{memberId}/stop
...
==== Error Response
include::{snippets}/game-stop-error-response-docs-test/error-code-response-test/common-error-code-response-fields-beneath-errorCodes.adoc[]
